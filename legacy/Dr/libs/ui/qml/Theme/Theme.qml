...
Object {
    ...
    readonly property alias listStyle: listStyle
...
//    property alias texgyreheros: texgyreheros
    ...
    Object {
        id: listStyle
        readonly property color rowBackground: '#333'
        readonly property color rowForeground: '#ddd'
        readonly property string defaultFontFamily: 'Helvetica Neue'
        readonly property int defaultFontSize: 14
        readonly property int defaultFontWeight: Font.Light
    }
