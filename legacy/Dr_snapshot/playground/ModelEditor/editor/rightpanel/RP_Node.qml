...
//    property var outEdges: objectData.outEdges()
    ...
    property var inEdges: handle.inEdges()
    property var outEdges: handle.outEdges()
        ...
        ColumnLayout {
            ...
            Loader {
                ...
                sourceComponent: GraphTreeView {
                    ...
                    sel.onCurrentChanged: {
                        var current = graphModel.getHandle( sel.currentIndex )
                        if( current.isValid ) {
                            createEdgeDialog.target = current
