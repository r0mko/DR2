...
void QRPCPlugin::registerTypes(const char *uri)
{
//    qDebug() << "Registering types" << uri;
    ...
    qRegisterMetaType<QVariantStreamer>();
    qRegisterMetaType<Message*>();
    qRegisterMetaTypeStreamOperators<QVariantStreamer>();

//    qRegisterMetaTypeStreamOperators<QJsonValue>();
//    qDebug() << "QJsonValue" << qMetaTypeId<QJsonValue>();
