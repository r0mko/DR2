...
//    qmlRegisterType<NodeTypeFilter>(uri, 1, 0, "NodeTypeFilter");
//    qmlRegisterType<NodeAttributeFilter>(uri, 1, 0, "NodeAttributeFilter");
//    qmlRegisterUncreatableType<NodeFilter>(uri, 1, 0, "NodeFilter", "NodeFilter is an abstract class");
