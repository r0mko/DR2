...
//    qDebug() << Q_FUNC_INFO << "m_viewTransform" << m_viewTransform;
    // QTransform(type=TxScale, 11=0.0908104 12=0 13=0 21=0 22=-0.0908104 23=0 31=-371875 32=686901 33=1)
}
...
QPointF GeoView::getPoint(QPointF geo)
{
    return m_viewTransform.map(geo);
}
