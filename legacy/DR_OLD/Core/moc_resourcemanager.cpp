...
**
** Created: Fri Apr 5 14:03:01 2013
...
static const char qt_meta_stringdata_ResourceManager[] = {
    "ResourceManager\0"
};
...
const QMetaObjectExtraData ResourceManager::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject ResourceManager::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_ResourceManager,
      qt_meta_data_ResourceManager, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &ResourceManager::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ResourceManager))
