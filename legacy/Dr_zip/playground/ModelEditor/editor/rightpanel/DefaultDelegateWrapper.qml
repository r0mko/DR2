...
ColumnLayout {
    ...
    property QtObject nodeModelData
    property bool modified: false
    onNodeModelDataChanged: {
        if (nodeModelData != null && nodeModelData.isValid === true)
            loader.objectData = nodeModelData
        else
            loader.objectData = null
    }
    Loader {
        id: loader
        ...
        active: root.nodeModelData != null || multiSelection
