...
public:
    ...
    inline int getRemoteType(int localType) const { return m_localTypeMap.value(localType, QMetaType::UnknownType); }
    inline int getLocalType(int remoteType) const { return m_remoteTypeMap.value(remoteType, QMetaType::UnknownType); }
...
private:
    ...
    Peer *          m_peer;
    RPCEngine *     m_engine;
    QMap<int, int>  m_localTypeMap;
    QMap<int, int>  m_remoteTypeMap;
    PuppetHash      m_puppets;
    QString         m_nodeName;
    QString         m_appName;
    QString         m_appVersion;
    SignalProxy *   m_signalProxy = nullptr;
