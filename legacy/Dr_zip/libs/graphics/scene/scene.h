...
class MyGraphicsScene : public QGraphicsScene
{
    Q_OBJECT
public:
    MyGraphicsScene(QObject *parent = 0) : QGraphicsScene(parent) { setItemIndexMethod(NoIndex); }

    void renderItems(QPainter *painter, const QRectF &sourceRect, const QRectF &targetRect, QVector<QGraphicsItem *> &itemVector);
...
private:
    void initSceneImpl(MyGraphicsScene *scene);
